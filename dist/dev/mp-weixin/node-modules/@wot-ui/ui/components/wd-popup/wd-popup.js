  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        q: common_vendor.o(handleClickModal, "02"),
        r: common_vendor.o(noop, "5f"),
        s: common_vendor.p({
          show: _ctx.modelValue,
          ["z-index"]: _ctx.zIndex,
          ["lock-scroll"]: _ctx.lockScroll,
        ...
        v: common_vendor.o(close, "04"),
        w: common_vendor.p({
          ["custom-class"]: "wd-popup__close",
          name: "close"
        })
      } : {}, {
        x: common_vendor.o(($event) => emit("before-enter"), "22"),
        y: common_vendor.o(($event) => emit("enter"), "ba"),
        z: common_vendor.o(($event) => emit("after-enter"), "5a"),
        A: common_vendor.o(($event) => emit("before-leave"), "31"),
        B: common_vendor.o(($event) => emit("leave"), "17"),
        C: common_vendor.o(($event) => emit("after-leave"), "13"),
        D: common_vendor.p({
          ["lazy-render"]: _ctx.lazyRender,
          ["custom-class"]: rootClass.value,
          ["custom-style"]: style.value,
