...
const __unplugin_components_0 = () => "../wd-badge/wd-badge.js";
if (!Array) {
  const _component_wd_badge = __unplugin_components_0;
  _component_wd_badge();
}
if (!Math) {
  (wdIcon + wdSticky + wdStickyBox)();
}
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        k: common_vendor.o(toggleMap, "af"),
        ...
        t: common_vendor.o(onTouchStart, "96"),
        v: common_vendor.o(onTouchMove, "8a"),
        w: common_vendor.o(onTouchEnd, "40"),
        x: common_vendor.o(onTouchEnd, "cb"),
        y: common_vendor.s(mapHeaderStyle.value),
        z: common_vendor.o(toggleMap, "fd"),
        ...
        K: common_vendor.o(toggleMap, "c9"),
        L: common_vendor.t(_ctx.mapTitle || common_vendor.unref(translate)("all")),
        M: common_vendor.s(mapHeaderStyle.value),
        N: common_vendor.f(common_vendor.unref(children), (item, index, i0) => {
          return {
        ...
        S: common_vendor.o(onTouchStart, "0b"),
        T: common_vendor.o(onTouchMove, "04"),
        U: common_vendor.o(onTouchEnd, "29"),
        V: common_vendor.o(onTouchEnd, "d4"),
        W: common_vendor.s(mapHeaderStyle.value),
        X: common_vendor.o(toggleMap, "25"),
