        ...
        <view class="bottomNav__inner" :style="navStyle">
            <view v-for="(item, idx) in items" :key="item.label" class="bottomNav__item"
                ...
                <view class="bottomNav__iconWrap">
                    <view :class="`${iconColor(idx, item.key)}`"></view>
...
const iconColor = (idx: number, key: string) => (idx === props.activeIndex ? `icons ${key} active` : `icons ${key}`)
...
.bottomNav__iconWrap {
    ...
    .home {
        background: url('@/assets/images/home-index.png') repeat-x center center / contain;
    }

    .message {
        background: url('@/assets/images/message-index.png') repeat-x center center / contain;
    }

    .resume {
        background: url('@/assets/images/resume-index.png') repeat-x center center / contain;
    }

    .mine {
        background: url('@/assets/images/mine-index.png') repeat-x center center / contain;
    }
