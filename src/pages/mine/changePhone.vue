            ...
            <view class="form">
                <view class="row">
                    <view class="row__icon">
                        <wd-icon name="phone" color="#1e5bff" size="36rpx" />
                    </view>
                    <view class="row__main">
                        <view class="phonePrefix">
                            <text class="phonePrefix__text">{{ countryCode }}</text>
                            <wd-icon name="caret-down" size="20rpx" color="rgba(0,0,0,0.22)" />
                        </view>
                ...
                <view class="row">
                    <view class="row__icon">
                        <wd-icon name="safe" color="#1e5bff" size="36rpx" />
                    </view>
                    <view class="row__main">
                ...
                <view class="row">
                    <view class="row__icon">
                        <wd-icon name="email" color="#1e5bff" size="36rpx" />
                    </view>
                    <view class="row__main">
