<template>
    <view class="page">
        <view class="nav">
            ...
            <view class="search">
                <FaIcon name="magnifying-glass" :size="32" color="rgba(0, 0, 0, 0.32)" />
                ...
                <view v-for="c in candidates" :key="c.userId" class="card" hover-class="card--pressed"
                    ...
                    <view class="card__main">
                        ...
                        <view class="bottomRow">
                            <view class="facts">
                                <view class="fact">
                                    <FaIcon name="location-dot" :size="22" color="rgba(0, 0, 0, 0.18)" />
                                    <view class="fact__text">{{ c.city }}</view>
                                </view>
                                <view class="fact">
                                    <FaIcon name="file-lines" :size="22" color="rgba(0, 0, 0, 0.16)" />
