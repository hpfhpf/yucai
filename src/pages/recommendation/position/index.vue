<template>
    <view class="page">
        ...
        <view class="search">
            <wd-icon name="search" size="32rpx" color="rgba(0, 0, 0, 0.28)" />
        ...
        <view id="position-filters" class="filters">
            <view class="chip" :class="{ 'chip--active': areaPopupOpen || !!areaSelectedLabel }"
                ...
                <wd-icon :name="areaPopupOpen ? 'arrow-up' : 'arrow-down'" size="20rpx"
                    :color="areaPopupOpen || areaSelectedLabel ? 'var(--app-primary)' : 'rgba(0, 0, 0, 0.36)'" />
            </view>
            <view class="chip" :class="{ 'chip--active': industryPopupOpen || !!industrySelected }"
                ...
                <wd-icon :name="industryPopupOpen ? 'arrow-up' : 'arrow-down'" size="20rpx"
                    :color="industryPopupOpen || industrySelected ? 'var(--app-primary)' : 'rgba(0, 0, 0, 0.36)'" />
            </view>
            <view class="chip" :class="{ 'chip--active': salaryPopupOpen || !!salarySelected }"
                ...
                <wd-icon :name="salaryPopupOpen ? 'arrow-up' : 'arrow-down'" size="20rpx"
                    :color="salaryPopupOpen || salarySelected ? 'var(--app-primary)' : 'rgba(0, 0, 0, 0.36)'" />
            </view>
            <view class="chip" hover-class="chip--pressed" @click="handleFilterTap('more')">
                <view class="chip__text">更多筛选</view>
                <wd-icon name="arrow-down" size="20rpx" color="rgba(0, 0, 0, 0.36)" />
            </view>
        </view>
        ...
        <view class="bottomBar" :style="{ paddingBottom: `${safeBottom}px` }">
            <view class="opts-box">
                ...
                <view class="bottomBar__star" hover-class="bottomBar__star--pressed" @click="handleStarTap">
                    <wd-icon name="star" size="38rpx" color="rgba(0, 0, 0, 0.26)" />
                </view>
            </view>
