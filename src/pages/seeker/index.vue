            ...
            <view class="content">
                ...
                <view class="quick">
                    <view v-for="item in quickItems" :key="item.key"
                        ...
                        <view :class="`${item.key} quick__icon`"></view>
...
.fulltime {
    background: url('@/assets/images/fulltime-index.png') repeat-x center center / contain;
}

.parttime {
    background: url('@/assets/images/parttime-index.png') repeat-x center center / contain;
}

.deliveries {
    background: url('@/assets/images/deliveries-index.png') repeat-x center center / contain;
}

.credit {
    background: url('@/assets/images/credit-index.png') repeat-x center center / contain;
}
